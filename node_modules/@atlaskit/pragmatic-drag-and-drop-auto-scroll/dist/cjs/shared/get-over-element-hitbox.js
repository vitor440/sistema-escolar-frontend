...
function makeGetHitbox(_ref) {
  ...
  return function hitbox(_ref2) {
    ...
    return DOMRect.fromRect((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)({}, mainAxis.point, side === 'start' ?
