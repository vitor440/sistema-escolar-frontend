...
var _mergeProps = require("@base-ui/react/merge-props");
...
function evaluateRenderProp(element, render, props, state) {
  ...
  throw new Error(process.env.NODE_ENV !== "production" ? 'Base UI: Render element or function are not defined.' : (0, _formatErrorMessage2.default)(214));
}
...
function renderTag(Tag, props) {
  if (Tag === 'button') {
    return /*#__PURE__*/(0, _react.createElement)("button", (0, _extends2.default)({
      type: "button"
    }, props, {
      key: props.key
    }));
