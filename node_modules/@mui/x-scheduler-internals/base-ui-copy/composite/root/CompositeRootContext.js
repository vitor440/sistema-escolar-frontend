...
function useCompositeRootContext(optional = false) {
  ...
  if (context === undefined && !optional) {
    throw new Error(process.env.NODE_ENV !== "production" ? 'Base UI: CompositeRootContext is missing. Composite parts must be placed within <Composite.Root>.' : (0, _formatErrorMessage2.default)(221));
  }
  return context;
}