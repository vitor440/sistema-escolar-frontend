import type { GridRowType, GridCellCoordinates } from "../../models/calendarGrid.js";
export declare const DEFAULT_ROW_TYPES: GridRowType[];
 ...
 */
export declare function getNavigationTarget(key: string, rowType: GridRowType, rowIndex: number, columnIndex: number, options: NavigationOptions): GridCellCoordinates | null;