...
exports.DEFAULT_ROW_TYPES = void 0;
exports.getNavigationTarget = getNavigationTarget;
const DEFAULT_ROW_TYPES = exports.DEFAULT_ROW_TYPES = ['header', 'day-grid', 'time-grid'];
function getRowCount(rowsPerType, rowType) {
 ...
 */
function getNavigationTarget(key, rowType, rowIndex, columnIndex, options) {
  const {
    columnCount,
    rowTypes,
    rowsPerType
