...
import type { useDraggableEvent } from "./useDraggableEvent.js";
import { SchedulerEventSide } from "../../models/index.js";
export declare function useEventResizeHandler(parameters: useEventResizeHandler.Parameters): useEventResizeHandler.ReturnValue;
export declare namespace useEventResizeHandler {
  interface State {
    /**
