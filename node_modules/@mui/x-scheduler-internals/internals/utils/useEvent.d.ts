import { SchedulerEventId, SchedulerProcessedDate } from "../../models/index.js";
export declare function useEvent(parameters: useEvent.Parameters): useEvent.ReturnValue;
export declare namespace useEvent {
