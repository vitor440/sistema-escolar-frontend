import { TemporalTimezone, TemporalSupportedObject } from "../../base-ui-copy/types/index.js";
import { SchedulerProcessedEvent, WeekStartsOn } from "../../models/index.js";
 ...
 */
export declare function getWallTimeIsoFormat(adapter: Adapter): string;
/**
 ...
 */
export declare function dateToEventString(adapter: Adapter, date: TemporalSupportedObject, originalString: string, dataTimezone: TemporalTimezone): string;
export declare function mergeDateAndTime(adapter: Adapter, dateParam: TemporalSupportedObject, timeParam: TemporalSupportedObject): TemporalSupportedObject;
/**
 * Snaps an all-day event's bounds to span the whole day; non-all-day bounds are returned unchanged.
 */
export declare function normalizeAllDayBounds(adapter: Adapter, start: TemporalSupportedObject, end: TemporalSupportedObject, allDay: boolean | undefined): {
 ...
 */
export declare function getDateKey(day: TemporalSupportedObject, adapter: Adapter): string;
/**
 ...
 */
export declare function getOccurrenceEnd({
  event,
  occurrenceStart,
  adapter
}: {
 ...
 * is used unchanged.
 */
export declare function getStartOfWeek(adapter: Adapter, date: TemporalSupportedObject, weekStartsOn: WeekStartsOn | undefined): TemporalSupportedObject;
/**
 ...
 */
export declare function getEndOfWeek(adapter: Adapter, date: TemporalSupportedObject, weekStartsOn: WeekStartsOn | undefined): TemporalSupportedObject;
/**
 ...
 */
export declare function getWeekNumber(adapter: Adapter, date: TemporalSupportedObject, weekStartsOn: WeekStartsOn | undefined): number;