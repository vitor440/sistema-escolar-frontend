import { SchedulerEventCreationConfig } from "../../models/index.js";
import type { CreationPlaceholderFields } from "./useEventCreation.js";
 ...
 */
export declare function useKeyboardEventCreation(getCreationPlaceholder: (params: GetKeyboardCreationPlaceholderParams) => CreationPlaceholderFields): (() => void) | undefined;
export {};