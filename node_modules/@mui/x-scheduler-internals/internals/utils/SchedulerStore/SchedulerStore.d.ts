...
import { SchedulerEventId, SchedulerOccurrencePlaceholder, SchedulerResourceId, TemporalSupportedObject, SchedulerEventUpdatedProperties, RecurringEventScope, SchedulerPreferences, SchedulerEventCreationProperties, SchedulerEventPasteProperties } from "../../../models/index.js";
import { SchedulerState, SchedulerParameters, UpdateRecurringEventParameters, DeleteRecurringEventParameters, SchedulerParametersToStateMapper, UpdateEventsParameters, SchedulerInstanceName } from "./SchedulerStore.types.js";
import { SchedulerRecurringEventsPluginInterface } from "../../plugins/SchedulerRecurringEventsPlugin.types.js";
import { SchedulerEvents, SchedulerEventListener, SchedulerEventParameters } from "../../models/events.js";
import { Adapter } from "../../../use-adapter/useAdapter.types.js";
...
export declare class SchedulerStore<TEvent extends object, TResource extends object, State extends SchedulerState, Parameters extends SchedulerParameters<TEvent, TResource>> extends Store<State> {
   ...
   */
  setOccurrencePlaceholder: (newPlaceholder: SchedulerOccurrencePlaceholder | null) => void;
  /**
   * Sets the ID of the currently active event (e.g. open in the event dialog).
   * Pass `null` to clear the active event.
   */
  setEditedEventId: (eventId: SchedulerEventId | null) => void;
  /**
