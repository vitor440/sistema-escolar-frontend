...
import { TemporalTimezone } from "../../../base-ui-copy/types/temporal.mjs";
import { SchedulerEventColor, SchedulerEventCreationConfig, SchedulerEventCreationProperties, SchedulerEventId, SchedulerEventModelStructure, SchedulerEventUpdatedProperties, SchedulerOccurrencePlaceholder, SchedulerPreferences, SchedulerProcessedEvent, SchedulerResource, SchedulerResourceId, SchedulerResourceModelStructure, TemporalSupportedObject, SchedulerEventSide } from "../../../models/index.mjs";
import { Adapter, DateLocale } from "../../../use-adapter/useAdapter.types.mjs";
...
export interface SchedulerParameters<TEvent extends object, TResource extends object> {
   ...
   */
  onVisibleResourcesChange?: (visibleResources: Record<SchedulerResourceId, boolean>, eventDetails: SchedulerChangeEventDetails) => void;
  /**
   ...
   */
  onVisibleDateChange?: (visibleDate: TemporalSupportedObject, eventDetails: SchedulerChangeEventDetails) => void;
  /**
   * Whether the event can be dragged to change its start and end dates without changing the duration.
   * @default true
   */
 ...
 */
export interface SchedulerParametersToStateMapper<State extends SchedulerState, Parameters extends SchedulerParameters<any, any>> {
  /**
   ...
   */
  getInitialState: (schedulerInitialState: Omit<SchedulerState, 'shouldEventRequireResource'>, parameters: Parameters, adapter: Adapter) => State;
  /**
   * Updates the state based on the new parameters.
   */
  updateStateFromParameters: (newState: Partial<SchedulerState>, parameters: Parameters, updateModel: SchedulerModelUpdater<State, Parameters>) => Partial<State>;
}
export type SchedulerModelUpdater<State extends SchedulerState, Parameters extends SchedulerParameters<any, any>> = (newState: Partial<State>, controlledProp: keyof Parameters & keyof State & string, defaultProp: keyof Parameters) => void;
 ...
 */
export type SchedulerInstanceName = 'EventCalendarStore' | 'EventCalendarPremiumStore' | 'EventTimelinePremiumStore';