...
exports.useTimelineDragAutoScroll = useTimelineDragAutoScroll;
 ...
 */
function useTimelineDragAutoScroll(params) {
  const {
    scrollerRef,
    pinnedLeftWidth
  } = params;
  ...
  React.useEffect(() => {
    ...
    const nativeGetBoundingClientRect = Object.getOwnPropertyDescriptor(Element.prototype, 'getBoundingClientRect')?.value ?? Element.prototype.getBoundingClientRect;
    ...
    const cleanupAutoScroll = (0, _element.autoScrollForElements)({
      element: scroller
    });
    return () => {
      cleanupAutoScroll();
