...
import { RenderDragPreviewParameters } from "../../models/index.js";
/**
 * Returns the drag preview to render when the dragged event is not over a valid drop target.
 */
export declare function useDragPreview(parameters: useDragPreview.Parameters): useDragPreview.ReturnValue;
export declare namespace useDragPreview {
  type Parameters = RenderDragPreviewParameters & {
