import { EventCalendarPreferences, CalendarView, EventCalendarPreferencesMenuConfig, EventCalendarViewConfig } from "../models/index.mjs";
import { SchedulerState, SchedulerParameters, SchedulerChangeEventDetails } from "../internals/utils/SchedulerStore/index.mjs";
...
export interface EventCalendarParameters<TEvent extends object, TResource extends object> extends SchedulerParameters<TEvent, TResource> {
  /**
   ...
   */
  onPreferencesChange?: (preferences: Partial<EventCalendarPreferences>, eventDetails: SchedulerChangeEventDetails) => void;
  /**
   * Config of the preferences menu.
   * Defines which options are visible in the menu.
