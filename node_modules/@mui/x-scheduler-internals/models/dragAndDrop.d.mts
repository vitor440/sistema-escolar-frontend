import type { SchedulerEvent, SchedulerProcessedEventDraft } from "./event.mjs";
...
export interface SchedulerOccurrencePlaceholderExternalDragData extends Omit<SchedulerEvent, 'start' | 'end'> {
  /**
