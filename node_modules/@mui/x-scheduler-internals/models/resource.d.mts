import type { SchedulerEventColor, SchedulerEventSide } from "./event.mjs";
...
export type SchedulerResourceModelStructure<TResource extends object> = { [key in keyof SchedulerResource]?: {
