...
import { SchedulerProcessedEventRecurrenceRule, SchedulerEventRecurrenceRule } from "./recurringEvent.mjs";
import type { SchedulerOccurrencePlaceholderExternalDragData } from "./dragAndDrop.mjs";
import type { SchedulerResourceId } from "./resource.mjs";
export type { TemporalTimezone } from "../base-ui-copy/types/index.mjs";
/**
 ...
 */
export type SchedulerRenderableEventOccurrence = SchedulerEventOccurrence | SchedulerEventOccurrencePlaceholder;
export type SchedulerEventId = string | number;
export type SchedulerEventColor = 'red' | 'pink' | 'purple' | 'indigo' | 'blue' | 'teal' | 'green' | 'lime' | 'amber' | 'orange' | 'grey';
 ...
 */
export type SchedulerOccurrencePlaceholder = SchedulerOccurrencePlaceholderCreation | SchedulerOccurrencePlaceholderInternalDragOrResize | SchedulerOccurrencePlaceholderExternalDrag;
 ...
 */
export type SchedulerEventUpdatedProperties = Omit<Partial<SchedulerEvent>, 'start' | 'end' | 'exDates' | 'rrule'> & {
  id: SchedulerEventId;
  start?: TemporalSupportedObject;
  end?: TemporalSupportedObject;
  exDates?: TemporalSupportedObject[];
 ...
 */
export type SchedulerEventCreationProperties = Omit<SchedulerEvent, 'id' | 'start' | 'end' | 'exDates' | 'rrule'> & {
 ...
 */
export type SchedulerEventPasteProperties = Partial<Pick<SchedulerEvent, 'resource' | 'allDay'> & {
  start: TemporalSupportedObject;
}>;
/**
...
export type SchedulerEventModelStructure<TEvent extends object> = { [K in keyof SchedulerEvent]?: {
  getter: (event: TEvent) => SchedulerEvent[K];
  /**
   * Setter for the event property.
   * If not provided, the property won't be editable.
   */
  setter?: (event: TEvent | Partial<TEvent>, value: SchedulerEvent[K]) => TEvent | Partial<TEvent>;
} };
