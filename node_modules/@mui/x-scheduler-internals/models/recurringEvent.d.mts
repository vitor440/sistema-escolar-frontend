import type { TemporalSupportedObject } from "../base-ui-copy/types/index.mjs";
 ...
 */
export type RecurringEventByDayValue = RecurringEventWeekDayCode | `${RecurringEventByDayOrdinal}${RecurringEventWeekDayCode}`;
/**
