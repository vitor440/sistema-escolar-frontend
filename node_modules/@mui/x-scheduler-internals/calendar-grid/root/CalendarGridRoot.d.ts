...
import type { GridRowType } from "../../models/calendarGrid.js";
export declare const CalendarGridRoot: React.ForwardRefExoticComponent<Omit<CalendarGridRoot.Props, "ref"> & React.RefAttributes<HTMLDivElement>>;
export declare namespace CalendarGridRoot {
  interface State {}
