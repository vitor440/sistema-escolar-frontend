...
export declare const CalendarGridDayRowContext: React.Context<CalendarGridDayRowContext | undefined>;
export declare function useCalendarGridDayRowContext(): CalendarGridDayRowContext;