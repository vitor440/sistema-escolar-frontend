...
import { SchedulerProcessedDate } from "../../models/index.js";
export declare const CalendarGridHeaderCell: React.ForwardRefExoticComponent<Omit<CalendarGridHeaderCell.Props, "ref"> & React.RefAttributes<HTMLDivElement>>;
export declare namespace CalendarGridHeaderCell {
  interface State {
    /**
