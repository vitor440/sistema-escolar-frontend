...
export declare const CalendarGridTimeColumnContext: React.Context<CalendarGridTimeColumnContext | undefined>;
export declare function useCalendarGridTimeColumnContext(): CalendarGridTimeColumnContext;