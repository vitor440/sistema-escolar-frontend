...
import { disposeSymbol } from "../disposable/index.mjs";
 ...
 */
export const useDisposable = process.env.NODE_ENV === 'production' ? useDisposableProduction : useDisposableDevelopment;