 ...
 */
export const DisposableStack = globalThis.DisposableStack ?? CoreJsDisposableStack;
 ...
 */
export const AsyncDisposableStack = globalThis.AsyncDisposableStack ?? CoreJsAsyncDisposableStack;
