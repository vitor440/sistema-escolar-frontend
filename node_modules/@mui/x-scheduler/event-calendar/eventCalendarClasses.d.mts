import { EventDialogClasses } from "../internals/components/event-dialog/eventDialogClasses.mjs";
import { ErrorContainerClasses } from "../internals/components/error-container/errorContainerClasses.mjs";
import { EventSkeletonClasses } from "../internals/components/event-skeleton/eventSkeletonClasses.mjs";
export interface EventCalendarClasses extends EventDialogClasses, ErrorContainerClasses, EventSkeletonClasses {
...
export declare function getEventCalendarUtilityClass(slot: string): string;
export declare const eventCalendarClasses: EventCalendarClasses;
/**
 ...
 */
export declare const useEventCalendarUtilityClasses: (classes: Partial<EventCalendarClasses> | undefined) => EventCalendarClasses;