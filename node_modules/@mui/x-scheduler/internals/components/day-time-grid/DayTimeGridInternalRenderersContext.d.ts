...
import { TimeGridEventComponent } from "../event/time-grid-event/TimeGridEvent.types.js";
/**
...
export declare const DayTimeGridInternalRenderersContext: React.Context<DayTimeGridInternalRenderers>;
export declare function useDayTimeGridInternalRenderers(): DayTimeGridInternalRenderers;