...
import type { ControlledValue } from "./utils.mjs";
...
export declare const EventDialogOptionalRenderersContext: React.Context<EventDialogOptionalRenderers>;
export declare function useEventDialogOptionalRenderers(): EventDialogOptionalRenderers;