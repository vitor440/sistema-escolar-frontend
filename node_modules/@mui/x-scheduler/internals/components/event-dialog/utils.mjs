import { formatDayOfMonthAndMonthFullLetter } from "../../utils/date-utils.mjs";
const WEEKDAYS = ['sunday', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday'];
export const getWeekdayToken = (adapter, value) => {
  return WEEKDAYS[adapter.toJsDate(value).getDay()];
};
export function computeRange(adapter, next, displayTimezone) {
  if (next.allDay) {
    return {
...
export function validateRange(adapter, start, end, allDay) {
...
export function getRecurrenceLabel(adapter, start, recurrenceKey, localeText) {
  if (!recurrenceKey) {
