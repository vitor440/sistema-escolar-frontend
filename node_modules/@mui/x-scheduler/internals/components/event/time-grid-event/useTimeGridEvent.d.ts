...
import { TimeGridEventProps } from "./TimeGridEvent.types.js";
...
export declare function useTimeGridEvent(occurrence: TimeGridEventProps['occurrence']): UseTimeGridEventReturnValue;