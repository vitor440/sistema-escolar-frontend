...
const plPLDialog = {
  ...
  saveChanges: 'Zapisz',
  startDateAfterEndDateError: 'Data/godzina rozpoczęcia musi być wcześniejsza niż data/godzina zakończenia.',
...
const plPL = exports.plPL = (0, _getSchedulerLocalization.getSchedulerLocalization)({
  dialog: plPLDialog,
