...
import type { GridRowEntry, GridRowId, GridValidRowModel } from "../../../models/gridRows.mjs";
 ...
 */
export declare const gridVisibleRowsLookupSelector: import("@mui/x-data-grid").OutputSelector<GridStateCommunity, unknown, import("./gridFilterState.mjs").GridVisibleRowsLookupState>;
/**
 * @category Filtering
 * @ignore - do not document.
 */
