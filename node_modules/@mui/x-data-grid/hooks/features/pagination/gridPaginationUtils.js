...
const throwIfPageSizeExceedsTheLimit = (pageSize, signatureProp) => {
  if (signatureProp === _signature.GridSignature.DataGrid && pageSize > MAX_PAGE_SIZE) {
    throw new Error(process.env.NODE_ENV !== "production" ? `MUI X: \`pageSize\` cannot exceed 100 in the MIT version of the DataGrid.
You need to upgrade to DataGridPro or DataGridPremium component to unlock this feature.` : (0, _formatErrorMessage2.default)(83));
  }
};
