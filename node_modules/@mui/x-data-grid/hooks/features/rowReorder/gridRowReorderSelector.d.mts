...
export declare const gridRowReorderStateSelector: import("@mui/x-data-grid").OutputSelector<GridStateCommunity, unknown, import("./gridRowReorderInterfaces.mjs").GridRowReorderState>;
...
export declare const gridRowDropTargetSelector: (args_0: import("react").RefObject<{
  ...
  rowId: GridRowId;
  position: import("../../../internals/index.mjs").RowReorderDropPosition;
} | {
  rowId: null;
  position: null;
};
...
export declare const gridRowDropPositionSelector: (args_0: import("react").RefObject<{
  state: GridStateCommunity;
} | null>, rowId: GridRowId) => import("../../../internals/index.mjs").RowReorderDropPosition | null;
