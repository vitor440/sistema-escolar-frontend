...
const useGridPrintExport = (apiRef, props) => {
  ...
  const exportDataAsPrint = React.useCallback(async options => {
    ...
    if (!apiRef.current.rootElementRef.current) {
      throw new Error(process.env.NODE_ENV !== "production" ? 'MUI X Data Grid: No grid root element available for print export. ' + 'The grid must be mounted before exporting. ' + 'Ensure the DataGrid component is rendered and visible before calling exportDataAsPrint.' : (0, _formatErrorMessage2.default)(80));
    }
